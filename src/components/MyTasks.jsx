...
const MyTasks = () => {
    ...
    return (
        <div className="w-full  bg-gradient-to-t mt-3 rounded-2xl
         from-[white] to-[#d3e9f0] p-3">
            ...
            <div className=" grid grid-cols-2  lg:flex mb-2 w-full justify-start items-start gap-1   ">
                {
                    catrgoryTasks.map((item, index) => (
                        <button
                            ...
                            className={`border-2 rounded-4xl whitespace-nowrap border-gray-300 flex justify-between px-3 py-1 ${selectedstatus === item.title ? "bg-blue-200" : ""
                                }`}
                        >
            ...
            <button className="w-full mb-1 bg-blue-400 rounded-3xl text-white mt-5 py-3">View all tasks</button>
        </div>
    )
}
